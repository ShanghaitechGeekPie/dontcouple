...
then
	...
	sudo cp ./verilator/bin/* /usr/local/bin/ && sudo mkdir -p /usr/local/share/pkgconfig/ && sudo cp ./verilator/pkgconfig/* /usr/local/share/pkgconfig/ && sudo cp -r ./verilator/verilator/* /usr/local/share/verilator/
	exit $?
fi
